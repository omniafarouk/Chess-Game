...
public abstract class ChessGame implements Caretaker{
    ...
    private Stack<ChessGameMemento> gameStates= new Stack<>();
    ...
    public Player getOpponent() {
       return  whoseTurn==Player.BLACK ? Player.WHITE : Player.BLACK ;
    }
    ...
    public boolean makeMove(Move move) {
        ...
        //saves the current state of the board before changing 
        saveState();
        
        // implementing the actual move 
    ...
    public void saveState(){
        ChessGameMemento currentState = Originator.createState(this);
        gameStates.add(currentState);
    }
    
    @Override
    public void restoreState(){
       ChessGameMemento currentMemento = gameStates.pop();
        this.board = currentMemento.getBoardState();
        this.whoseTurn = currentMemento.getPlayerTurn();
        this.gameStatus = currentMemento.getGameStatus();
        this.lastMove = currentMemento.getLastMove();
    }
